...
class PermissionBuilder(
    ...
    fun showHandlePermissionDialog(
        ...
        positiveButton.setOnClickListener {
            ...
            if (showReasonOrGoSettings) {
                ...
                forwardToSettings(permissions,handledListener)
            }
        }
     ...
     */
    private fun forwardToSettings(permissions: List<String>,handledListener: (()->Unit)?=null) {
        forwardPermissions.clear()
        forwardPermissions.addAll(permissions)
        invisibleFragment.forwardToSettings(handledListener)
    }
