...
class ForwardScope internal constructor(
     ...
     */
    fun showForwardToSettingsDialog(dialog: RationaleDialog,positiveButtonClickListener: (() -> Unit)? = null,handledListener: (() -> Unit)?) {
        pb.showHandlePermissionDialog(chainTask, false, dialog,positiveButtonClickListener,handledListener)
    }
